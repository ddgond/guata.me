...
description: A guide on memorizing area codes for various countries (yes, even the 300+ present in North America).
...
{/* Dan: 1-2 sentences introducing the inline Japan quiz below — e.g. that you can drill it right here instead of (or before) heading to helloquiz, and that turning off Borders is the second drill stage. Also consider whether the paragraph above should still point at helloquiz first. */}
...
As you can see, the connections made can be super tenuous, and the beauty is that they'll still work! If Japan comes easily, I recommend following it up with [Brazil](https://helloquiz.app/quiz/ktGyB5qaJTWb), which also has well-grouped two-digit area codes.

{/* Dan: a short line introducing the inline Brazil quiz below. */}
